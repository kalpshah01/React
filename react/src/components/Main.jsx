...
<div className="container">
  ...
  <div className="row">
    ...
    <div className="col-md-3">
      <div className="card">
        <img src={i1} className="card-img-top" alt="Category" />
    ...
    <div className="col-md-3">
      <div className="card">
        <img src={i2} className="card-img-top" alt="Category" />
        <div className="card-body">
          <h3>WEDDING BANDS </h3>
    ...
    <div className="col-md-3">
      <div className="card">
        <img src={i3} className="card-img-top" alt="Category" />
        <div className="card-body">
    ...
    <div className="col-md-3">
      <div className="card">
        <img src={i4} className="card-img-top" alt="Category" />
        <div className="card-body">

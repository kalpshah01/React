...
<div className="container py-5" style={{color:'white'}}>
  ...
  <div class="row align-items-center mb-5">
    <div class="col-lg-6 mb-4 mb-lg-0">
      <img src="https://digitalupgrade.com/images/lobbyimage_1.jpg" class="img-fluid rounded" alt="Lobby Image"/>
    </div>
    <div class="col-lg-6">
  ...
  <div class="row align-items-center">
    <div class="col-lg-6 order-lg-2 mb-4 mb-lg-0">
      <img src="https://digitalupgrade.com/images/building_pic.jpg" class="img-fluid rounded" alt="Building Pic" />
    </div>
